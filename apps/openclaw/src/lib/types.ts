...
// ─────────────────────────────────────────────────
// Inlined types from @terragon/shared (ui-messages)
// ─────────────────────────────────────────────────
...
export type UISystemMessage =
  | {
      role: "system";
      message_type: DBSystemMessageType;
      parts: UITextPart[];
    }
  | {
      role: "system";
...
export type DBSystemMessageType =
  | "cancel-schedule"
  | "fix-github-checks"
...
// ─────────────────────────────────────────────────
// DB Message types (for toUIMessages)
// ─────────────────────────────────────────────────
...
type DBAgentMessage = {
  ...
  parts: (UITextPart | UIThinkingPart)[];
};
...
type DBMetaMessage = {
  type: "meta";
  subtype: "result-success" | "result-error-max-turns";
};
